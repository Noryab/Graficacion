...
class Plane : public Object {
	...
	Plane ();    
    Plane (QVector3D, double, QVector3D,float _Amb,float _Diff,float _Spec);
...
Plane::Plane (QVector3D normalValue, double distanceValue, QVector3D colorValue, float _Amb, float _Diff,float _Spec)
{
	normal = normalValue;
