...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        radioButton_7->setGeometry(QRect(1020, 300, 133, 26));
        QPalette palette9;
        palette9.setBrush(QPalette::Active, QPalette::WindowText, brush);
        palette9.setBrush(QPalette::Inactive, QPalette::WindowText, brush);
        palette9.setBrush(QPalette::Disabled, QPalette::WindowText, brush1);
        radioButton_7->setPalette(palette9);
        ...
        QObject::connect(radioButton_7, SIGNAL(clicked()), MainWindow, SLOT(Phong()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        radioButton_7->setText(QApplication::translate("MainWindow", "Phong", Q_NULLPTR));
    } // retranslateUi
