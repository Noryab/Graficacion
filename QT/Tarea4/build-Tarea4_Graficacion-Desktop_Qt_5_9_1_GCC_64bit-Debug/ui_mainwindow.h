...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        radioButton_3->setGeometry(QRect(1020, 360, 133, 26));
        QPalette palette5;
        ...
        radioButton_4->setGeometry(QRect(1020, 330, 133, 26));
        QPalette palette6;
        ...
        radioButton_6->setGeometry(QRect(1020, 300, 133, 26));
        QPalette palette8;
        palette8.setBrush(QPalette::Active, QPalette::WindowText, brush);
        palette8.setBrush(QPalette::Inactive, QPalette::WindowText, brush);
        palette8.setBrush(QPalette::Disabled, QPalette::WindowText, brush1);
        radioButton_6->setPalette(palette8);
        ...
        QObject::connect(radioButton_3, SIGNAL(clicked()), MainWindow, SLOT(Phong()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        radioButton_3->setText(QApplication::translate("MainWindow", "Phong", Q_NULLPTR));
